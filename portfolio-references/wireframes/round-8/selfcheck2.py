...
const small=[...document.querySelectorAll('nav a, summary, [data-block="HB"] a, [data-block="PS"] a, [data-block="HB7"] a, [data-block="HP7"] a, [data-block="PS7"] a, [data-block="KCm"] button, [data-block^="C1"] a, [data-block^="IL"] a, [data-block^="IP"] > a')].filter(vis).map(e=>{const b=e.getBoundingClientRect();return {t:e.textContent.slice(0,24),w:Math.round(b.width),h:Math.round(b.height)}}).filter(o=>o.w<44||o.h<44);
